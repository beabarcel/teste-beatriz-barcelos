...
public class StatementPrinterTests
{
    ...
    public void TestStatementExampleLegacy()
    {
        ...
        StatementCalculator statementPrinter = new StatementCalculator();

        var statementResult = statementPrinter.CalculateStatement(invoice, plays);
    ...
    public void TestXMLStatementExample()
    {
        ...
        var result = statementPrinter.PrintXML(statementResult);
